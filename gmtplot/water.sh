#!/bin/bash 
gmt begin water_1d png
 #  gmt subplot begin 1x4 -Fs9c/16c

  # gmt subplot set 0,0
   gmt basemap -R0/4/0/150 -JX9c/-16c -Bxa0.5f0.25+l"water content (wt%)" -Bya25f50+l"depth (km)" -BWSne
   gmt psxy water.txt -W1.5p,darkgrey # -l"Vs (dry solidus)"
